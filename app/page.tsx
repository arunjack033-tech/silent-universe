...
const copy: Record<Language, Copy> = {
  en: {
    ...
    fromPlaceholder: "from: the place that brought us together.",
    ...
    envelopeFirst: `Open the envelope first ${LOVE_ICON}`,
    ...
    revealSurprise: `Reveal the surprise${LOVE_ICON}`,
    ...
    openFinal: `Open the final page ${LOVE_ICON}`,
    ...
    fromLabel: "From",
    fromFallback: `Someone who loves you deeply${LOVE_ICON}`,
...
const pureTamilCopy: Copy = {
  ...
  fromPlaceholder: "நம்மை இணைத்த இடம்.",
  linePlaceholder: "உன் காதலை வார்த்தைகளில் வெளிப்படுத்து.",
  previewPrefix: "முன்னோட்டம்:",
  ...
  envelopeEyebrow: "திறந்து பார்",
  envelopeTitle: "நம் காதலின் ஆழத்தை வார்த்தைகளால் அளக்க முடியாது. இந்த மென்மையான நினைவுகளை உணருங்கள் இதயம்.",
  envelopeDescription: "இந்தப் பகுதி பழைய உறை தருணத்தை அப்படியே வைத்துக்கொண்டு இன்னும் இனிமையாகத் திறக்கிறது.",
  hiddenNote: "ரகசிய குறிப்பு",
  hiddenText: "நம் முதல் சந்திப்பு முதல் இன்று வரை, ஒவ்வொரு தருணமும் என் வாழ்க்கையில் அழகான மாற்றங்களை ஏற்படுத்தியது. உன் சிரிப்பு, உன் பார்வை, உன் அன்பு— என் முழு உலகத்தையும் மாற்றி அமைத்துவிட்டது. உன் அருகில் நான் இருப்பது, என் இதயத்தின் அமைதியான ஓய்வு.",
  ...
  envelopeFirst: `முதலில் உறையைத் திற${LOVE_ICON}`,
  nextMemory: `அடுத்த நினைவு ${LOVE_ICON}`,
  exploreEyebrow: "காதல் பயணம்",
  ...
  revealSurprise: `ஆச்சரியத்தைத் திற ${LOVE_ICON}`,
  ...
  openFinal: `கடைசி பக்கத்தைத் திற ${LOVE_ICON}`,
  finalEyebrow: "கடைசி பக்கம்",
  ...
  fromFallback: `உன்னை ஆழமாக நேசிக்கும் ஒருவர் ${LOVE_ICON}`,
